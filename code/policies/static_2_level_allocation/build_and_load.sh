...
MODULE="static_allocation_policy"
...
if ! lsmod | grep -q "^e1000 "; then
    ...
    echo "    static_allocation_policy requires e1000 (exports in_rx_alloc, in_clean_alloc)."
...
echo "      nid                — target node for page allocations"
echo "      force_small_enable — toggle SKB alloc NUMA forcing (0/1)"
echo "      small_nid          — target node for SKB allocations"
